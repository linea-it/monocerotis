    ...
    <Container>
      ...
      >
        <Grid
          ...
          className={classes.grid}
        >
          <Typography variant="h6" color="primary" className={classes.title}>Rationale:</Typography><br />
          ...
          <Typography variant="h6" color="primary" className={classes.title}>Venue:</Typography><br />
          <Typography variant="subtitle1" color="primary" className={classes.description}>
