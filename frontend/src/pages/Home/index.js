        ...
        <Grid container>
          <Grid item xs={12}>
              ...
              <Grid container spacing={3} justify="center">
                ...
                <br />
                <div>
                  <Typography align="center" color="primary" className={classes.blockText}>Andreas Wicenec (ICRAR/UWA)</Typography>
                  ...
                  <Typography align="center" color="primary" className={classes.blockText}>William O’Mullane (LSST/Vera C. Rubin Observatory)</Typography>
                </div>
                </Grid>
                <Grid item xs={12} md={6} >
